...
public class UserController implements Serializable {
    ...
    @EJB
    private bean.UserFacade ejbFacade;
    ...
    public static class UserControllerConverter implements Converter {
        ...
        entity.User getKey(String value) {
            entity.User key;
            key = value;
            return key;
        }

        String getStringKey(entity.User value) {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof User) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.
                        getClass().getName() + "; expected type: " + User.class.getName());
            }
        }
